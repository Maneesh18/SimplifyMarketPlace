...
public class EducationResource {
    ...
    public ResponseEntity<EducationDTO> updateEducation(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, educationDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<EducationDTO> partialUpdateEducation(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, educationDTO.getId())
        );
    }
    ...
    public ResponseEntity<EducationDTO> getEducation(@PathVariable String id) {
