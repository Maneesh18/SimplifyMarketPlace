...
public class EmploymentResource {
    ...
    public ResponseEntity<EmploymentDTO> createEmployment(@Valid @RequestBody EmploymentDTO employmentDTO) throws URISyntaxException {
    ...
    public ResponseEntity<EmploymentDTO> updateEmployment(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, employmentDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<EmploymentDTO> partialUpdateEmployment(
        @PathVariable(value = "id", required = false) final String id,
        @NotNull @RequestBody EmploymentDTO employmentDTO
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, employmentDTO.getId())
        );
    }
