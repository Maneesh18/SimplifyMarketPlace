...
public class JobPreferenceResource {
    ...
    public ResponseEntity<JobPreferenceDTO> createJobPreference(@Valid @RequestBody JobPreferenceDTO jobPreferenceDTO)
    ...
    public ResponseEntity<JobPreferenceDTO> updateJobPreference(
        ...
        @Valid @RequestBody JobPreferenceDTO jobPreferenceDTO
    ) throws URISyntaxException {
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, jobPreferenceDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<JobPreferenceDTO> partialUpdateJobPreference(
        @PathVariable(value = "id", required = false) final String id,
        @NotNull @RequestBody JobPreferenceDTO jobPreferenceDTO
    ) throws URISyntaxException {
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, jobPreferenceDTO.getId())
        );
    }
    ...
    public ResponseEntity<JobPreferenceDTO> getJobPreference(@PathVariable String id) {
    ...
    public ResponseEntity<Void> deleteJobPreference(@PathVariable String id) {
