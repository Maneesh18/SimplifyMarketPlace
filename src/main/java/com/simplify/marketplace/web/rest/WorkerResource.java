...
public class WorkerResource {
    ...
    public ResponseEntity<WorkerDTO> createWorker(@Valid @RequestBody WorkerDTO workerDTO) throws URISyntaxException {
        ...
        else if (workerRepository.findOneByEmailIgnoreCase(workerDTO.getEmail()).isPresent()) {
    ...
    public ResponseEntity<WorkerDTO> updateWorker(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workerDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<WorkerDTO> partialUpdateWorker(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, workerDTO.getId())
        );
    }
