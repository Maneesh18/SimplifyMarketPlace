              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('city')}>
                    <Translate contentKey="simplifyMarketplaceApp.address.city">City</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th className="hand" onClick={sort('country')}>
                    <Translate contentKey="simplifyMarketplaceApp.address.country">Country</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  ...
                  <th className="hand" onClick={sort('createdBy')}>
                    <Translate contentKey="simplifyMarketplaceApp.address.createdBy">Created By</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('createdAt')}>
                    <Translate contentKey="simplifyMarketplaceApp.address.createdAt">Created At</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('updatedBy')}>
                    <Translate contentKey="simplifyMarketplaceApp.address.updatedBy">Updated By</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('updatedAt')}>
                    <Translate contentKey="simplifyMarketplaceApp.address.updatedAt">Updated At</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th>
                    <Translate contentKey="simplifyMarketplaceApp.address.worker">Worker</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
              <tbody>
                {addressList.map((address, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>
                      <Translate contentKey={`simplifyMarketplaceApp.AddressTag.${address.tag}`} />
                    </td>
                    ...
                    <td>{address.worker ? <Link to={`worker/${address.worker.id}`}>{address.worker.id}</Link> : ''}</td>
