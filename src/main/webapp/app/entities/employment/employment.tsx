              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('category')}>
                    <Translate contentKey="simplifyMarketplaceApp.employment.category">Category</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('subCategory')}>
                    <Translate contentKey="simplifyMarketplaceApp.employment.subCategory">Sub Category</Translate>{' '}
                    <FontAwesomeIcon icon="sort" />
                  </th>
              ...
              <tbody>
                {employmentList.map((employment, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>
                      <Translate contentKey={`simplifyMarketplaceApp.Category.${employment.category}`} />
                    </td>
                    <td>
                      <Translate contentKey={`simplifyMarketplaceApp.SubCategory.${employment.subCategory}`} />
                    </td>
