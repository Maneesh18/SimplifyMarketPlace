              ...
              <tbody>
                {jobPreferenceList.map((jobPreference, i) => (
                  <tr key={`entity-${i}`} data-cy="entityTable">
                    ...
                    <td>
                      <Translate contentKey={`simplifyMarketplaceApp.Category.${jobPreference.category}`} />
                    </td>
                    <td>
                      <Translate contentKey={`simplifyMarketplaceApp.SubCategory.${jobPreference.subCategory}`} />
                    </td>
