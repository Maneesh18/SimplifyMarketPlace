    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="otpId">
              <Translate contentKey="simplifyMarketplaceApp.oTP.otpId">Otp Id</Translate>
            </span>
          </dt>
          <dd>{oTPEntity.otpId}</dd>
          <dt>
            <span id="email">
          ...
          <dt>
            <Translate contentKey="simplifyMarketplaceApp.oTP.worker">Worker</Translate>
          </dt>
          <dd>{oTPEntity.worker ? oTPEntity.worker.id : ''}</dd>
        </dl>
