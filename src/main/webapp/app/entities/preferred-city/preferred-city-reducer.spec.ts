...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PREFERREDCITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_PREFERREDCITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PREFERREDCITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PREFERREDCITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PREFERREDCITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PREFERREDCITY actions', async () => {
      const expectedActions = [
        {
