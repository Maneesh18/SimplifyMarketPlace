              ...
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={sort('name')}>
                    <Translate contentKey="simplifyMarketplaceApp.worker.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('email')}>
                    <Translate contentKey="simplifyMarketplaceApp.worker.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th className="hand" onClick={sort('phone')}>
                    <Translate contentKey="simplifyMarketplaceApp.worker.phone">Phone</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
